...
| 2022-11-18 | 367,077 | 373,114 | 6,038 | none | 204 | 167 |  | 20,565 | 380  |   |   |
| 2022-11-17 | 360,177 | 367,076 | 6,900 | none | 364 | 297 |  | 25,907 | 728  |   |   |
| 2022-11-16 | 353,248 | 360,176 | 6,929 | none | 597 | 438 |  | 29,533 | 1,210  |   |   |
...
### Blocks
```
SELECT date(block_time) as logDT, MIN(number) startBN, MAX(number) endBN, COUNT(*) numBlocks FROM `substrate-etl.kusama.block2129`  where signed and LAST_DAY(date(block_time)) = "2022-11-30" group by logDT order by logDT
```

...
module.exports = class InterlayParser extends ChainParser {
    ...
    */
    ...
    async processInterlayAssetsRegistryAssetRegistryInfo(chainkey, a) {
        ...
        for (let i = 0; i < a.length; i++) {
            ...
            if (cachedAssetInfo != undefined && cachedAssetInfo.symbol != undefined) {
                ...
                // type V0/V1/...
                let xcmAssetTypeV = (xcmAssetSruct.location != undefined) ? Object.keys(xcmAssetSruct.location)[0] : 'V1'
    ...
    async processInterlayXcGar(chainkey) {
        ...
        if (a) {
            ...
            let [xcAssetList, assetIDList, updatedAssetList, unknownAsset] = await this.processInterlayAssetsRegistryAssetRegistryInfo(chainkey, a)

...
module.exports = class AstarParser extends ChainParser {
    ...
    async fetchAssetPallet(chainkey) {
        console.log(`Astar custom fetchAssetPallet`)
    ...
    async fetchXCMAssetIdToLocation(chainkey) {
        console.log(`Astar custom fetchXCMAssetIdType`)
        ...
        if (a){
            ...
            console.log(`Astar custom xcAssetList=${Object.keys(xcAssetList)},updatedAssetList=${Object.keys(updatedAssetList)},unknownAsset=${Object.keys(unknownAsset)}`, xcAssetList)

    ...
    processOutgoingXTokens(indexer, extrinsic, feed, fromAddress, section_method, args) {
        ...
        for (var xcmtransfer of generalOutgoingXcmList) {
            if (xcmtransfer == undefined) {
                ...
                let [targetedXcmInteriorKey] = this.check_refintegrity_symbol(xcmAssetSymbol, relayChain, chainID, chainIDDest, "moonbeam processOutgoingXTokens - processXcmGenericCurrencyID")
            ...
            */
            ...
            if (section_method == "xcmTransactor:transactThroughDerivative") {
                ...
                */
                ...
                let [targetedXcmInteriorKey] = this.check_refintegrity_symbol(targetedSymbol, relayChain, chainID, chainIDDest, "processOutgoingXCMTransactor - xcmTransactor:transactThroughDerivative", a.currency_id)
                ...
                if (a !== undefined && a.fee_location !== undefined) {
                    ...
                    if (feeSymbol) {
                        ...
                        let [feeXcmInteriorKey] = this.check_refintegrity_symbol(targetedSymbol, feeRelayChain, chainID, chainIDDest, "processOutgoingXCMTransactor -xcmTransactor:transactThroughDerivativeMultilocation", feelocation)
                ...
                */
                ...
                if (a !== undefined && a.fee_location !== undefined) {
                    ...
                    if (feeSymbol) {
                        targetedSymbol = feeSymbol
                        let [feeXcmInteriorKey] = this.check_refintegrity_symbol(targetedSymbol, feeRelayChain, chainID, chainIDDest, "xcmTransactor:transactThroughSignedMultilocation", feelocation)
                        if (feeXcmInteriorKey) targetedXcmInteriorKey = feeXcmInteriorKey
                    }
                }
                ...
                */
                ...
                let targetedSymbol = this.processXcmGenericCurrencyID(indexer, a.currency_id) //inferred approach
                let [targetedXcmInteriorKey] = this.check_refintegrity_symbol(targetedSymbol, relayChain, chainID, chainIDDest, "processOutgoingXCMTransactor - xcmTransactor:transactThroughSigned", a.currency_id)
                ...
                if (a !== undefined && a.fee_location !== undefined) {
                    ...
                    if (feeSymbol) {
                        targetedSymbol = feeSymbol
                        let [feeXcmInteriorKey] = this.check_refintegrity_symbol(targetedSymbol, feeRelayChain, chainID, chainIDDest, "xcmTransactor:transactThroughSovereign", feelocation)
                        if (feeXcmInteriorKey) targetedXcmInteriorKey = feeXcmInteriorKey
                    }
                }

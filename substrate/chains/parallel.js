        ...
        */
        ...
        for (var xcmtransfer of generalOutgoingXcmList) {
            if (xcmtransfer == undefined) {
                ...
                let targetedXcmInteriorKey = indexer.check_refintegrity_symbol(xcmAssetSymbol, relayChain, chainID, chainIDDest, "processXcmGenericCurrencyID", "parallel processOutgoingXTokens", a.currency_id)
        ...
        */
        ...
        for (var xcmtransfer of generalOutgoingXcmList) {
            if (xcmtransfer == undefined) {
                ...
                let chainID = xcmtransfer.chainID
                let chainIDDest = xcmtransfer.chainIDDest
                let targetedXcmInteriorKey = indexer.check_refintegrity_symbol(xcmAssetSymbol, relayChain, chainID, chainIDDest, "processXcmDecHexCurrencyID", "parallel processOutgoingXcmPallet", a.currency_id)
                xcmtransfer.xcmSymbol = xcmAssetSymbol
                xcmtransfer.xcmInteriorKey = targetedXcmInteriorKey
                outgoingXcmList.push(xcmtransfer)
            } else {

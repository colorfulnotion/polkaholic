    ...
    async getXCMTimeline(hash, hashType = "extrinsic", blockNumber = null, decorate = true, decorateExtra = true, advanced = true) {
        ...
        try {
            ...
            if (hashType == "xcm") {
                ...
                let sql = `select extrinsicID, extrinsicHash, parentMsgHash, parentSentAt, parentBlocknumber, childMsgHash, childSentAt, childBlocknumber, msgHash, sentAt, assetChains, incoming, version from xcmmessages where msgHash = '${hash}' ${w} order by blockTS desc limit 1`

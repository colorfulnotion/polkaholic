...
module.exports = class Crawler extends Indexer {
    ...
    async crawlTrace(chain, blockHash, blockNumber, timeoutMS = 20000) {
        ...
        try {
            ...
            let cmd = `curl --silent -H "Content-Type: application/json" --max-time 240 --connect-timeout 60 -d '{"id":1,"jsonrpc":"2.0","method":"state_traceBlock","params":["${blockHash}","state","","Put"]}' "${chain.RPCBackfill}"`
